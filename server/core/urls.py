...
from .api_endpoints import user_views, course_views, cookie_views, password_reset_views
...
urlpatterns = [
    ...
    path('user/validate-credentials/', user_views.validate_user_credentials, name='verify-credentials'),
    path('user/validate-registration-code/', user_views.validate_registration_code, name='verify-password'),
    ...
    path('courses/validate/', course_views.validate_course_schedule, name='validate-course-schedule'),
