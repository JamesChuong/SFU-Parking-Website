...
function NavigationBar(props: NavBarProps){
    ...
    return (
        ...
        <nav className="relative bg-gray-800 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
                    ...
                    <div className="relative flex flex-row justify-center">
                        ...
                        <div className="relative flex flex-row justify-center">
                            ...
                            <div className="flex space-x-4 p-2">
                                ...
                                <button type="button" className="relative flex items-center justify-center rounded-md px-3 py-2 text-sm font-medium rounded-md p-1 text-gray-400 hover:text-white focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500 text-white"
                                onClick={openSideBar}>
                                    {props.username}
                                </button>
            ...
            {sideBarOpen? <AccountSideBar /> : null}
